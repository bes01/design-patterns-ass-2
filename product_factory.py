...
from models import Sellable, Item, ItemGroup
...
class ProductFactory:
    ...
    def create_random_item(self) -> Sellable:
        return random.choice([self.create_cheese, self.create_beer, self.create_bread, self.create_6x_beer_pack,
    ...
    def create_6x_beer_pack(self) -> Sellable:
        ...
        return ItemGroup(name=item_group["name"], discount=item_group["discount"],
    ...
    def create_bread_and_cheese_combo(self) -> Sellable:
        ...
        return ItemGroup(name=item_combo["name"], discount=item_combo["discount"], items=[item_1, item_2])
